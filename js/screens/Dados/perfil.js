        ...
        <Content style={[this.state.styles_aqui.FundoInternas,{marginTop: -5}]}>
          ...
          <List>
            ...
            <View style={{flexDirection: 'row', paddingHorizontal: 5, marginTop: 5, marginBottom: 5}}>
              <Button style={[this.state.styles_aqui.btnFundoBranco,{ width: '100%', marginLeft: 0}]} onPress={() => this.props.updateState([],"DadosEditar")}>
                <Text style={[this.state.styles_aqui.btnFundoBrancoTxt,style_personalizado.Font12]}>Editar meu dados</Text>
              </Button>
            </View>
            ...
            <ListItem style={[this.state.styles_aqui.lista_cabecalho_fundo,this.state.styles_aqui.lista_cabecalho_borda]} itemDivider>
              <Text style={[this.state.styles_aqui.lista_cabecalho_titulo]}>Informações da Conta</Text>
            </ListItem>
