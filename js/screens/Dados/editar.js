...
import { StyleSheet, Image, Text, TextInput, View, FlatList, Dimensions,  TouchableHighlight, TouchableOpacity } from 'react-native';
        ...
        {(() => {
          ...
          <List>
                ...
                return (
                  ...
                  {(() => {
                    if (this.state.config_empresa.campo_cliente_genero == '1') {
                      return (
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              <RNPickerSelect
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              ...
                              value={this.state.aceita_whatsapp}
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              ...
                              value={this.state.tipo_sanguineo}
                              placeholder={{ label: '', value: '0'}}
                                  style={{
                                    ...
                                    items={this.state.tipo_sanguineo_array}
                              />
                            </View>
                          </View>
                        </View>
                  ...
                  {(() => {
                    if (this.state.config_empresa.campo_cliente_profissional_da_saude == '1' ||
                      ...
                      return (
                        <ListItem style={[this.state.styles_aqui.lista_cabecalho_fundo,this.state.styles_aqui.lista_cabecalho_borda,{marginTop:5}]} itemDivider>
                          <Text style={[this.state.styles_aqui.lista_cabecalho_titulo]}>Outros</Text>
                        </ListItem>
                      )
                    }
                  })()}
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              ...
                              value={this.state.categorias_de_pessoas}
                              placeholder={{ label: '', value: '0'}}
                                  style={{
                                      inputIOS: {
                                          color: this.state.styles_aqui.campo_txt_cor,
                                  ...
                                  items={this.state.categorias_de_pessoas_array}
                              />
                            </View>
                          </View>
                        </View>
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              ...
                              value={this.state.numeroUnico_atividades}
                              placeholder={{ label: 'Selecione uma opção', value: '0'}}
                                  style={{
                                      inputIOS: {
                                          color: this.state.styles_aqui.campo_txt_cor,
                                  ...
                                  items={this.state.numeroUnico_atividades_array}
                              />
                            </View>
                          </View>
                        </View>
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              ...
                              value={this.state.numeroUnico_unidades_de_saude}
                              placeholder={{ label: '', value: '0'}}
                                  style={{
                                      inputIOS: {
                                          color: this.state.styles_aqui.campo_txt_cor,
                                  ...
                                  items={this.state.numeroUnico_unidades_de_saude_array}
                              />
                            </View>
                          </View>
                        </View>
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              ...
                              value={this.state.profissional_da_saude}
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              ...
                              value={this.state.encontrase_acamado}
                              placeholder={{ label: 'Selecione uma opção', value: ''}}
                                  style={{
                                      inputIOS: {
                                          color: this.state.styles_aqui.campo_txt_cor,
                        ...
                        <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                            <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                              ...
                              value={this.state.contraiu_doenca}
                              placeholder={{ label: 'Selecione uma opção', value: ''}}
                                  style={{
                                      inputIOS: {
                                          color: this.state.styles_aqui.campo_txt_cor,
                          ...
                          <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between' }}>
                            <View style={{ flex: 1, flexDirection:'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 2 }}>
                              <View style={{ width: (Dimensions.get('window').width - 20), backgroundColor: this.state.styles_aqui.campo_fundo_cor, borderColor: this.state.styles_aqui.campo_borda_cor, borderRadius:5, borderWidth: 1, paddingTop: 10 }}>
                                ...
                                value={this.state.numeroUnico_vacinas}
                                placeholder={{ label: 'Selecione uma opção', value: ''}}
                                    style={{
                                        inputIOS: {
                                            color: this.state.styles_aqui.campo_txt_cor,
                                    ...
                                    items={this.state.numeroUnico_vacinas_array}
                                />
                              </View>
                            </View>
                          </View>
            ...
            {(() => {
              if (this.state.perfil.navegacao == 'profissional') {
                return (
                  <>
                  <ListItem style={[this.state.styles_aqui.lista_cabecalho_fundo,this.state.styles_aqui.lista_cabecalho_borda]} itemDivider>
                    <Text style={[this.state.styles_aqui.lista_cabecalho_titulo]}>Meus dados</Text>
                  </ListItem>
                  {(() => {
            ...
            <ListItem style={{borderBottomWidth: 0, marginBottom: this.state.styles_aqui.marginBottomContainer}}>
              <Button style={this.state.styles_aqui.btnFundoBranco} onPress={() => Functions._salvaPerfil(this)}>
                <Text style={this.state.styles_aqui.btnFundoBrancoTxt}>Salvar Alterações</Text>
              </Button>
            </ListItem>
