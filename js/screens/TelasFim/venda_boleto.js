...
const TELA_LOCAL = 'BoletoSucesso';
      ...
      <Container style={this.state.styles_aqui.FundoInternas}>
        ...
        <Content style={[this.state.styles_aqui.FundoInternas,{marginTop: -5}]}>
          ...
          <View>
            ...
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginBottom:80, textAlign: 'center'}}>Sua compra foi concluída com sucesso</Text>
            </Grid>
          </View>
          ...
          <View>
            <Grid>
              <Text style={[this.state.styles_aqui.titulo_colorido_m,{width:'100%', fontSize:30, marginTop:60, textAlign: 'center'}]}>ATENÇÃO</Text>
            </Grid>
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginBottom: 0, textAlign: 'center', padding: 10}}>Você irá receber no seu e-mail as informações do boleto para realizar o pagamento, ou vá até o menu "Meus Ingressos" para ver os detalhes e visualizar o código de barras para realizar o pagamento.</Text>
            </Grid>
          </View>
