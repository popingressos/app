...
const TELA_LOCAL = 'CompraEmAnalise';
      ...
      <Container style={this.state.styles_aqui.FundoInternas}>
        ...
        <Content style={[this.state.styles_aqui.FundoInternas,{marginTop: -5}]}>
          ...
          <View>
            ...
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginBottom:80, textAlign: 'center'}}>Sua compra foi enviada para análise</Text>
            </Grid>
          </View>
            ...
            <View style={{ flex: 1, flexDirection:'row', justifyContent: 'center', paddingHorizontal: 2, marginTop: 5 }}>
              <View style={[styles_interno.item_sem_sombra,this.state.styles_aqui.box_cor_de_fundo,{backgroundColor: 'transparent'}]}>
                  <View style={{padding: 5, width: '100%'}}>
                    <ReactVectorIcons.IconFont3 style={[this.state.styles_aqui.box_cor_de_icone,{fontSize: 90, textAlign: 'center', width: '100%'}]} name='credit-card-clock-outline' />
                  </View>
              </View>
            </View>
          </View>
          ...
          <View>
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginTop:50, marginBottom: 0, textAlign: 'center', padding: 20}}>Vá até o menu "Minhas Compras" para ver os detalhes da sua compra e acompanhar o processo de liberação.</Text>
            </Grid>
