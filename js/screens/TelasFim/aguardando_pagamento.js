      ...
      <Container style={this.state.styles_aqui.FundoInternas}>
        ...
        <Content style={[this.state.styles_aqui.FundoInternas,{marginTop: -5, marginBottom: this.state.styles_aqui.marginBottomContainer}]}>
          ...
          <View>
            ...
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginTop:20, marginBottom:80, textAlign: 'center', paddingHorizontal: 20}}>Se você escolheu a opção de pagamento via boleto, <Text style={{fontWeight: 'bold'}}>pode levar até 72horas</Text> do dia de pagamento para confirmação e seu cadastro será liberado.</Text>
            </Grid>
          </View>
