...
const TELA_LOCAL = 'PedidoSucesso';
      ...
      <Container style={this.state.styles_aqui.FundoInternas}>
        ...
        <Content style={[this.state.styles_aqui.FundoInternas,{marginTop: -5}]}>
          ...
          <View>
            ...
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginBottom:80, textAlign: 'center'}}>Seu pedido foi realizado com sucesso</Text>
            </Grid>
          </View>
          ...
          <View>
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginTop:50, marginBottom: 0, textAlign: 'center', padding: 20}}>Vá até o menu "Minhas Compras" para ver os detalhes da sua compra e fazer o acompanhamento do mesmo.</Text>
            </Grid>
