...
const TELA_LOCAL = 'IngressoSucesso';
      ...
      <Container style={this.state.styles_aqui.FundoInternas}>
        ...
        <Content style={[this.state.styles_aqui.FundoInternas,{marginTop: -5}]}>
          ...
          <View>
            ...
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginBottom:80, textAlign: 'center'}}>Seu ingresso foi adquirido com sucesso</Text>
            </Grid>
          </View>
          ...
          <View>
            <Grid>
              <Text style={{width:'100%', fontSize:12, marginTop:50, marginBottom: 0, textAlign: 'center', padding: 20}}>Vá até o menu "Meus Ingressos" para ver os detalhes da sua aquisição e visualizar o QRCode do item adquirido.</Text>
            </Grid>
            <Button style={this.state.styles_aqui.btnFundoBranco} onPress={() => this.props.navigation.navigate('MeusIngressos')}>
              <Text style={this.state.styles_aqui.btnFundoBrancoTxt}>Meus Ingressos</Text>
            </Button>
          </View>
