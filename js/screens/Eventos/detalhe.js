            ...
            <Content style={[this.state.styles_aqui.FundoInternas,{marginTop: -5}]}>
              ...
              <Tabs tabBarUnderlineStyle={this.state.styles_aqui.tab_borda} tabsContainerStyle={this.state.styles_aqui.tab_fundo}>
                <Tab
                 ...
                 heading={ <TabHeading style={{backgroundColor:'#FFF'}}><Text style={[this.state.styles_aqui.titulo_colorido_m, style_personalizado.Font14, style_personalizado.FontBold]}>{this.state.config_empresa.label_tickets_plural}</Text></TabHeading>}>
