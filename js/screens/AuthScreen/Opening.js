...
import { StyleSheet, ImageBackground, SafeAreaView, Image, Dimensions, Platform, TouchableOpacity } from 'react-native'
...
export default class Opening extends Component {
  ...
  render () {
    const { isLoading, onLoginPress, localOpeningSet } = this.props
